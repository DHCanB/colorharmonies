...
def triadicColor(ColorInput):
	...
	SecondTriadicHue = ((ColorInput.HLS[0] * 360 + 220) % 360) / 360

	# Find the third triadic Hue
	thirdTriadicHue = ((ColorInput.HLS[0] * 360 + 60) % 360) / 360

	# Find the forth triadic Hue
	forthTriadicHue = ((ColorInput.HLS[0] * 360 + 180) % 360) / 360
	...
	ColorOutput3 = Color("",[thirdTriadicHue,ColorInput.HLS[1],ColorInput.HLS[2]],"")
	ColorOutput4 = Color("",[forthTriadicHue,ColorInput.HLS[1],ColorInput.HLS[2]],"")
	...
	ColorOutput4.RGB = list(map(lambda x: round(x * 255),colorsys.hls_to_rgb(ColorOutput4.HLS[0],ColorOutput4.HLS[1],ColorOutput4.HLS[2])))

	return [ColorOutput1.RGB, ColorOutput2.RGB, ColorOutput3.RGB, ColorOutput4.RGB]
